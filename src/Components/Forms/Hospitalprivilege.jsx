          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSearch(); }}>
            <div className="search">
              <div className="search-input">
                ...
                <select name="Blood_group" onChange={(e) => setBloodGroup(e.target.value)} required>
              ...
              <div className="search-input">
                ...
                <input type="varchar" className="form-control" required name="Home_address" onChange={(e) => setHomeAddress(e.target.value)} placeholder="" />
              </div>
            </div>
