          ...
          <div className="col-12 col-lg-7">
            <div className="dashboard">
              ...
              <div className="reports">
                ...
                <div className="info">
                  <h6>More Info</h6>
                  <button type="button" className="btn5 btn-success" onClick={handleDonateNowClick2}>
                    <IoArrowForwardCircleOutline />
                  </button>
                </div>
              </div>
              <div className="reports">
                ...
                <div className="info">
                  <h6>More Info</h6>
                  <button type="button" className="btn5 btn-success" onClick={handleDonateNowClick3}>
                    <IoArrowForwardCircleOutline />
                  </button>
                </div>
              </div>
